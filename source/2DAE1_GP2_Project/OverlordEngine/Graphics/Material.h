...
public:
	...
	void Unbind(const GameContext& gameContext)
	{
		UnbindShadowMap(gameContext);
	};
...
protected:
	...
	virtual void UnbindShadowMap(const GameContext& gameContext) { UNREFERENCED_PARAMETER(gameContext); };
