...
protected:
	...
	virtual void Draw_ShadowMap(const GameContext& gameContext) { UNREFERENCED_PARAMETER(gameContext); };
	//draw_shadowmap
...
private:
	...
	virtual void RootDraw_ShadowMap(const GameContext& gameContext);
